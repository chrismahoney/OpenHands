...
def display_settings(config: OpenHandsConfig) -> None:
    ...
    # Add the configuration file path at the beginning
    config_file_path = os.path.expanduser(config.file_store_path)
    config_file_path = os.path.join(config_file_path, "settings.json")
    labels_and_values = [("Configuration file", str(config_file_path))]
